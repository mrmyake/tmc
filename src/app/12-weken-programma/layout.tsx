 ...
 * Navbar/Footer/InfoOptInBanner (zie
 ...
 * marketingpagina, geen auth/CMS-scherm zoals /app, /studio, /login of
 * /checkin. Die andere door SiteShell uitgesloten routes missen de banner
 * bewust omdat ze geen publiek marketingverkeer krijgen. GA4 laadt sitebreed
 * (zie layout.tsx) met
