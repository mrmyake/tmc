...
- Schaal: de kandidatenlijst wordt in pagina's van 1000 gelezen (PostgREST-rijlimiet), Akiles-lijsten volgen `cursor_next` met `limit=100`. De OpenAPI-spec noemt geen rate limit; de client wacht bij 429 of 503 op `Retry-After` (anders 2 s) en probeert hooguit drie keer. Circa vijf calls per lid, sequentieel.
