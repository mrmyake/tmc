...
export default async function TrainerSessionPage(props: {
  ...
  // /kiosk linkt hierheen als tweede ingang naar deze deelnemerslijst
  // (zelfde markAttendance(), geen eigen kopie); ?from=kiosk geeft de
  // trainer een weg terug naar de kiosk-vandaag-weergave in plaats van
  // de gewone sessielijst.
  const fromKiosk = from === "kiosk";
  ...
  return (
    <div className="px-4 sm:px-6 md:px-10 pt-6 pb-16">
      <div className="max-w-xl mx-auto mb-6">
        <Link
          href={fromKiosk ? "/kiosk" : "/app/trainer/sessies"}
        ...
        >
          ...
          {fromKiosk ? "Terug naar kiosk" : "Terug naar sessies"}
        </Link>
      </div>
